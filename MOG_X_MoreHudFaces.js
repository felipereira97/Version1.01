/*:
 * @plugindesc v1.2.1 An extension plugin for Moghunter's Battle, Actor, and Party HUDs with options to change the face graphics.
		...
		if (Imported.MOG_BattleHud && SceneManager._scene.constructor == Scene_Battle)  {
			...
			battleHud.forEach(function(bhud) {
				if (bhud._battler && bhud._battler._actorId === this._actorId) {
					bhud._face.bitmap = ImageManager.loadBHud(this._bhud_face_file);
				}
			}, this);
		}
	}
